...
enum cursor_res
cursor_read_le_u8(struct cursor * csr, uint8_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_i8(struct cursor * csr, int8_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_u16(struct cursor * csr, uint16_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_i16(struct cursor * csr, int16_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_u32(struct cursor * csr, uint32_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_i32(struct cursor * csr, int32_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_u64(struct cursor * csr, uint64_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_f(struct cursor * csr, float * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_d(struct cursor * csr, double * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_u8(struct cursor * csr, uint8_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_i8(struct cursor * csr, int8_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_u16(struct cursor * csr, uint16_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_i16(struct cursor * csr, int16_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_u32(struct cursor * csr, uint32_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_i32(struct cursor * csr, int32_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_u64(struct cursor * csr, uint64_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_le_i64(struct cursor * csr, int64_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_i64(struct cursor * csr, int64_t * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_f(struct cursor * csr, float * restrict dst)
{
    SIZE_CHECK(csr, *dst);
...
enum cursor_res
cursor_read_be_d(struct cursor * csr, double * restrict dst)
{
    SIZE_CHECK(csr, *dst);
